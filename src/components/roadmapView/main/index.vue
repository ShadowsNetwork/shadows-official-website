<template>
  <div class="road">
    <div class="road-title wow fadeIn" data-wow-duration="3.5s" data-wow-delay="0.3s">
      <span>Road Ahead 21</span>
    </div>
...
.road {
  ...
  padding-top: 150px;
  background: url("../../../assets/image/roadmap/roadmap_bg.jpg") no-repeat;
